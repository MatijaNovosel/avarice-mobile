...
abstract class $TagCopyWith<$Res> {
  ...
  $Res call({String description, int id});
}
...
class _$_Tag implements _Tag {
  const _$_Tag({required this.description, required this.id});
  ...
  @override
  String toString() {
    return 'Tag(description: $description, id: $id)';
  }
...
abstract class _Tag implements Tag {
  const factory _Tag(
      {required final String description, required final int id}) = _$_Tag;
